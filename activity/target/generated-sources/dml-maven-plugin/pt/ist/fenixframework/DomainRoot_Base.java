...
public abstract class DomainRoot_Base extends pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject {
    // Static Slots
    public final static pt.ist.fenixframework.dml.runtime.RoleMany<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider> role$$activityProvider = new pt.ist.fenixframework.dml.runtime.RoleMany<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider>() {
        public pt.ist.fenixframework.dml.runtime.RelationBaseSet<pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider> getSet(pt.ist.fenixframework.DomainRoot o1) {
            return ((DomainRoot_Base)o1).get$rl$activityProvider();
        }
        public pt.ist.fenixframework.dml.runtime.Role<pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider,pt.ist.fenixframework.DomainRoot> getInverseRole() {
            return pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider.role$$root;
        }
    ...
    private final static class DomainRootHasActivityProviders {
        private static final pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider> relation = new pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider>(role$$activityProvider, "DomainRootHasActivityProviders");
    }
    public static pt.ist.fenixframework.dml.runtime.DirectRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider> getRelationDomainRootHasActivityProviders() {
        return DomainRootHasActivityProviders.relation;
    }
    
    static {
        DomainRootHasActivityProviders.relation.setRelationName("pt.ist.fenixframework.DomainRoot.DomainRootHasActivityProviders");
    }
    private static pt.ist.fenixframework.dml.runtime.KeyFunction<Comparable<?>,pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider> keyFunction$$activityProvider = new pt.ist.fenixframework.dml.runtime.KeyFunction<Comparable<?>,pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider>() { public Comparable<?> getKey(pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider value) { return value.getOid(); } public boolean allowMultipleKeys() {return false; }};
    ...
    // Role Slots
    private RelationList<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider> get$rl$activityProvider() {
        return get$$relationList("activityProvider", getRelationDomainRootHasActivityProviders());
    ...
    public void addActivityProvider(pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider activityProvider) {
        getRelationDomainRootHasActivityProviders().add((pt.ist.fenixframework.DomainRoot)this, activityProvider);
    }
    
    public void removeActivityProvider(pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider activityProvider) {
        getRelationDomainRootHasActivityProviders().remove((pt.ist.fenixframework.DomainRoot)this, activityProvider);
    }
    
    public java.util.Set<pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider> getActivityProviderSet() {
        return get$rl$activityProvider();
    }
    
    public void set$activityProvider(OJBFunctionalSetWrapper activityProvider) {
        get$rl$activityProvider().setFromOJB(this, "activityProvider", activityProvider);
    }
    
    @Deprecated
    public java.util.Set<pt.ulisboa.tecnico.softeng.activity.domain.ActivityProvider> getActivityProvider() {
        return getActivityProviderSet();
    }
    
    @Deprecated
    public int getActivityProviderCount() {
        return getActivityProviderSet().size();
    }
    ...
    protected void checkDisconnected() {
        ...
        if (get$rl$activityProvider().size() > 0) handleAttemptToDeleteConnectedObject("ActivityProvider");
    ...
    protected pt.ist.fenixframework.dml.runtime.Relation get$$relationFor(String attrName) {
        if (attrName.equals("activityProvider")) return getRelationDomainRootHasActivityProviders();
    ...
    protected void create$allLists() {
        ...
        get$$relationList("activityProvider", getRelationDomainRootHasActivityProviders());
