...
public abstract class DomainRoot_Base extends pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject {
    ...
    public final static pt.ist.fenixframework.dml.runtime.RoleMany<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.broker.domain.Broker> role$$broker = new pt.ist.fenixframework.dml.runtime.RoleMany<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.broker.domain.Broker>() {
        public pt.ist.fenixframework.dml.runtime.RelationBaseSet<pt.ulisboa.tecnico.softeng.broker.domain.Broker> getSet(pt.ist.fenixframework.DomainRoot o1) {
            return ((DomainRoot_Base)o1).get$rl$broker();
        }
        public pt.ist.fenixframework.dml.runtime.Role<pt.ulisboa.tecnico.softeng.broker.domain.Broker,pt.ist.fenixframework.DomainRoot> getInverseRole() {
            return pt.ulisboa.tecnico.softeng.broker.domain.Broker.role$$root;
        }
    ...
    private final static class DomainRootHasBrokerApplication {
        private static final pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.broker.domain.Broker> relation = new pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.broker.domain.Broker>(role$$broker, "DomainRootHasBrokerApplication");
    }
    public static pt.ist.fenixframework.dml.runtime.DirectRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.broker.domain.Broker> getRelationDomainRootHasBrokerApplication() {
        return DomainRootHasBrokerApplication.relation;
    }
    
    static {
        DomainRootHasBrokerApplication.relation.setRelationName("pt.ist.fenixframework.DomainRoot.DomainRootHasBrokerApplication");
    }
    private static pt.ist.fenixframework.dml.runtime.KeyFunction<Comparable<?>,pt.ulisboa.tecnico.softeng.broker.domain.Broker> keyFunction$$broker = new pt.ist.fenixframework.dml.runtime.KeyFunction<Comparable<?>,pt.ulisboa.tecnico.softeng.broker.domain.Broker>() { public Comparable<?> getKey(pt.ulisboa.tecnico.softeng.broker.domain.Broker value) { return value.getOid(); } public boolean allowMultipleKeys() {return false; }};
    ...
    // Role Slots
    private RelationList<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.broker.domain.Broker> get$rl$broker() {
        return get$$relationList("broker", getRelationDomainRootHasBrokerApplication());
    ...
    public void addBroker(pt.ulisboa.tecnico.softeng.broker.domain.Broker broker) {
        getRelationDomainRootHasBrokerApplication().add((pt.ist.fenixframework.DomainRoot)this, broker);
    }
    
    public void removeBroker(pt.ulisboa.tecnico.softeng.broker.domain.Broker broker) {
        getRelationDomainRootHasBrokerApplication().remove((pt.ist.fenixframework.DomainRoot)this, broker);
    }
    
    public java.util.Set<pt.ulisboa.tecnico.softeng.broker.domain.Broker> getBrokerSet() {
        return get$rl$broker();
    }
    
    public void set$broker(OJBFunctionalSetWrapper broker) {
        get$rl$broker().setFromOJB(this, "broker", broker);
    }
    
    @Deprecated
    public java.util.Set<pt.ulisboa.tecnico.softeng.broker.domain.Broker> getBroker() {
        return getBrokerSet();
    }
    
    @Deprecated
    public int getBrokerCount() {
        return getBrokerSet().size();
    }
    ...
    protected void checkDisconnected() {
        ...
        if (get$rl$broker().size() > 0) handleAttemptToDeleteConnectedObject("Broker");
    ...
    protected pt.ist.fenixframework.dml.runtime.Relation get$$relationFor(String attrName) {
        if (attrName.equals("broker")) return getRelationDomainRootHasBrokerApplication();
    ...
    protected void create$allLists() {
        ...
        get$$relationList("broker", getRelationDomainRootHasBrokerApplication());
