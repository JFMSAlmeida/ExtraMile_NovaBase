...
public abstract class DomainRoot_Base extends pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject {
    // Static Slots
    public final static pt.ist.fenixframework.dml.runtime.RoleMany<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.bank.domain.Bank> role$$bank = new pt.ist.fenixframework.dml.runtime.RoleMany<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.bank.domain.Bank>() {
        public pt.ist.fenixframework.dml.runtime.RelationBaseSet<pt.ulisboa.tecnico.softeng.bank.domain.Bank> getSet(pt.ist.fenixframework.DomainRoot o1) {
            return ((DomainRoot_Base)o1).get$rl$bank();
        }
        public pt.ist.fenixframework.dml.runtime.Role<pt.ulisboa.tecnico.softeng.bank.domain.Bank,pt.ist.fenixframework.DomainRoot> getInverseRole() {
            return pt.ulisboa.tecnico.softeng.bank.domain.Bank.role$$root;
        }
    ...
    private final static class DomainRootHasBankApplication {
        private static final pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.bank.domain.Bank> relation = new pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.bank.domain.Bank>(role$$bank, "DomainRootHasBankApplication");
    }
    public static pt.ist.fenixframework.dml.runtime.DirectRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.bank.domain.Bank> getRelationDomainRootHasBankApplication() {
        return DomainRootHasBankApplication.relation;
    }
    
    static {
        DomainRootHasBankApplication.relation.setRelationName("pt.ist.fenixframework.DomainRoot.DomainRootHasBankApplication");
    }
    private static pt.ist.fenixframework.dml.runtime.KeyFunction<Comparable<?>,pt.ulisboa.tecnico.softeng.bank.domain.Bank> keyFunction$$bank = new pt.ist.fenixframework.dml.runtime.KeyFunction<Comparable<?>,pt.ulisboa.tecnico.softeng.bank.domain.Bank>() { public Comparable<?> getKey(pt.ulisboa.tecnico.softeng.bank.domain.Bank value) { return value.getOid(); } public boolean allowMultipleKeys() {return false; }};
    ...
    // Role Slots
    private RelationList<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.bank.domain.Bank> get$rl$bank() {
        return get$$relationList("bank", getRelationDomainRootHasBankApplication());
    ...
    public void addBank(pt.ulisboa.tecnico.softeng.bank.domain.Bank bank) {
        getRelationDomainRootHasBankApplication().add((pt.ist.fenixframework.DomainRoot)this, bank);
    }
    
    public void removeBank(pt.ulisboa.tecnico.softeng.bank.domain.Bank bank) {
        getRelationDomainRootHasBankApplication().remove((pt.ist.fenixframework.DomainRoot)this, bank);
    }
    
    public java.util.Set<pt.ulisboa.tecnico.softeng.bank.domain.Bank> getBankSet() {
        return get$rl$bank();
    }
    
    public void set$bank(OJBFunctionalSetWrapper bank) {
        get$rl$bank().setFromOJB(this, "bank", bank);
    }
    
    @Deprecated
    public java.util.Set<pt.ulisboa.tecnico.softeng.bank.domain.Bank> getBank() {
        return getBankSet();
    }
    
    @Deprecated
    public int getBankCount() {
        return getBankSet().size();
    }
    ...
    protected void checkDisconnected() {
        ...
        if (get$rl$bank().size() > 0) handleAttemptToDeleteConnectedObject("Bank");
    ...
    protected pt.ist.fenixframework.dml.runtime.Relation get$$relationFor(String attrName) {
        if (attrName.equals("bank")) return getRelationDomainRootHasBankApplication();
    ...
    protected void create$allLists() {
        ...
        get$$relationList("bank", getRelationDomainRootHasBankApplication());
