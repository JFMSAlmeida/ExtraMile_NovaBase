...
public abstract class DomainRoot_Base extends pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject {
    ...
    public final static pt.ist.fenixframework.dml.runtime.RoleMany<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.hotel.domain.Hotel> role$$hotel = new pt.ist.fenixframework.dml.runtime.RoleMany<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.hotel.domain.Hotel>() {
        public pt.ist.fenixframework.dml.runtime.RelationBaseSet<pt.ulisboa.tecnico.softeng.hotel.domain.Hotel> getSet(pt.ist.fenixframework.DomainRoot o1) {
            return ((DomainRoot_Base)o1).get$rl$hotel();
        }
        public pt.ist.fenixframework.dml.runtime.Role<pt.ulisboa.tecnico.softeng.hotel.domain.Hotel,pt.ist.fenixframework.DomainRoot> getInverseRole() {
            return pt.ulisboa.tecnico.softeng.hotel.domain.Hotel.role$$root;
        }
    ...
    private final static class DomainRootHasHotels {
        private static final pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.hotel.domain.Hotel> relation = new pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.hotel.domain.Hotel>(role$$hotel, "DomainRootHasHotels");
    }
    public static pt.ist.fenixframework.dml.runtime.DirectRelation<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.hotel.domain.Hotel> getRelationDomainRootHasHotels() {
        return DomainRootHasHotels.relation;
    }
    
    static {
        DomainRootHasHotels.relation.setRelationName("pt.ist.fenixframework.DomainRoot.DomainRootHasHotels");
    }
    private static pt.ist.fenixframework.dml.runtime.KeyFunction<Comparable<?>,pt.ulisboa.tecnico.softeng.hotel.domain.Hotel> keyFunction$$hotel = new pt.ist.fenixframework.dml.runtime.KeyFunction<Comparable<?>,pt.ulisboa.tecnico.softeng.hotel.domain.Hotel>() { public Comparable<?> getKey(pt.ulisboa.tecnico.softeng.hotel.domain.Hotel value) { return value.getOid(); } public boolean allowMultipleKeys() {return false; }};
    ...
    // Role Slots
    private RelationList<pt.ist.fenixframework.DomainRoot,pt.ulisboa.tecnico.softeng.hotel.domain.Hotel> get$rl$hotel() {
        return get$$relationList("hotel", getRelationDomainRootHasHotels());
    ...
    public void addHotel(pt.ulisboa.tecnico.softeng.hotel.domain.Hotel hotel) {
        getRelationDomainRootHasHotels().add((pt.ist.fenixframework.DomainRoot)this, hotel);
    }
    
    public void removeHotel(pt.ulisboa.tecnico.softeng.hotel.domain.Hotel hotel) {
        getRelationDomainRootHasHotels().remove((pt.ist.fenixframework.DomainRoot)this, hotel);
    }
    
    public java.util.Set<pt.ulisboa.tecnico.softeng.hotel.domain.Hotel> getHotelSet() {
        return get$rl$hotel();
    }
    
    public void set$hotel(OJBFunctionalSetWrapper hotel) {
        get$rl$hotel().setFromOJB(this, "hotel", hotel);
    }
    
    @Deprecated
    public java.util.Set<pt.ulisboa.tecnico.softeng.hotel.domain.Hotel> getHotel() {
        return getHotelSet();
    }
    
    @Deprecated
    public int getHotelCount() {
        return getHotelSet().size();
    }
    ...
    protected void checkDisconnected() {
        ...
        if (get$rl$hotel().size() > 0) handleAttemptToDeleteConnectedObject("Hotel");
    ...
    protected pt.ist.fenixframework.dml.runtime.Relation get$$relationFor(String attrName) {
        if (attrName.equals("hotel")) return getRelationDomainRootHasHotels();
    ...
    protected void create$allLists() {
        ...
        get$$relationList("hotel", getRelationDomainRootHasHotels());
